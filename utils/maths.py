...
def clamp_value(value=0, min_val=0, max_val=0):
...
def remap_value(value=0, min_a=0, max_a=0, min_b=0, max_b=0):
...
def round_value_to_increment(value=0, increment=15):
...
def loc_to_matrix_4x4(loc=None):
...
def quat_to_matrix_4x4(quat=None):
...
def sca_to_matrix_4x4(sca=None):
...
def loc_sca_to_matrix_4x4(loc=None, sca=None):
...
def vectors_to_matrix_4x4(dir_1=None, dir_2=None):
...
def plane_matrix(point=None, normal=None):
...
def transposed_rot_matrix(matrix=None):
...
def normal_transform_matrix(matrix=None):
...
def remove_location_from_matrix(matrix=None):
...
def remove_rotation_from_matrix(matrix=None):
...
def remove_scale_from_matrix(matrix=None):
...
def normal_from_triangle(p1=None, p2=None, p3=None):
...
def triangles_from_object_bounds(obj=None, transform=True):
...
def scale_triangle_from_center(p1=None, p2=None, p3=None, scalar=1):
...
def bvh_tree_from_object_bounds(obj=None, scalar=1.0):
...
def bvh_tree_from_bmesh_bounds(bm=None, mat_ws=None, scalar=1.0):
...
def sphere_from_obj_bounds(obj=None):
...
def bounding_box_wires_and_corners(obj, scalar=1.0):
